...
\newcommand{\sage}{\SAGE} %used by sagetex! switch to renew if need sagetex package
...
% hint environment
% this is just so you can "fold" chapters
% like functions in code.
% It helps with a long file
% note codefolding for codemirror comes from
% http://codemirror.977696.n3.nabble.com/code-folding-for-latex-td4028923.html
\newenvironment{ch}{}{}
% end newenvironment
